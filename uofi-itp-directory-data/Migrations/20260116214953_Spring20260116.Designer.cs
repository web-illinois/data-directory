...
namespace uofi_itp_directory_data.Migrations
{
    ...
    [Migration("20260116214953_Spring20260116")]
    partial class Spring20260116
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("uofi_itp_directory_data.DataModels.AreaSettings", b =>
                {
                    ...
                    b.Property<string>("InstructionsEmployeeCourses")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("uofi_itp_directory_data.DataModels.Employee", b =>
                {
                    ...
                    b.Property<bool>("UseAlternateContactAsPrimary")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("uofi_itp_directory_data.DataModels.EmployeeCourse", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("uofi_itp_directory_data.DataModels.Office", b =>
                {
                    ...
                    b.Property<string>("HoursTextOverride")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("uofi_itp_directory_data.DataModels.SecurityEntry", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            IsFullAdmin = true,
                            IsPublic = false,
                            LastUpdated = new DateTime(2026, 1, 16, 15, 49, 51, 6, DateTimeKind.Local).AddTicks(7207),
                        ...
                        new
                        {
                            ...
                            IsFullAdmin = true,
                            IsPublic = false,
                            LastUpdated = new DateTime(2026, 1, 16, 15, 49, 51, 6, DateTimeKind.Local).AddTicks(7331),
                            ListedNameFirst = "Rob",
            ...
            modelBuilder.Entity("uofi_itp_directory_data.DataModels.JobProfileTag", b =>
                {
                    b.HasOne("uofi_itp_directory_data.DataModels.JobProfile", "JobProfile")
                        .WithMany("Tags")
